...
ActiveRecord::Schema.define(version: 2022_05_12_223633) do
  ...
  create_table "profiles", charset: "latin1", force: :cascade do |t|
    t.bigint "users_id"
  ...
  create_table "teams", charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["accounts_id"], name: "index_teams_on_accounts_id"
  ...
  add_foreign_key "teams", "accounts", column: "accounts_id"
